...
Computer Science 1 - James Mitchell - Assigment 4:18
...
public class RanNumGuessGameJamesM
{
...
*/
  ...
  // Declare Variables for Program.
   String input;
   int userGuess = 0, randNum = 0, guessCount = 0;
   ...
   do
   {
     // Get a guessed number from the user. 
      ...
      userGuess = convertInput(input); // Call convertInput to parse Users input.
         guessCount ++; // Increment the users guess count by 1.
      ...
      else // This is an empty else that way if user guesses correct it continues out of
         { // do while loop to present user the message that they are Correct and how many
         } // times they guessed.
         
   }while (userGuess != randNum); // Continue in Do while loop as long as users guess is wrong.
   
  // If users guess is correct display this message box.
